...
// // let lastMessageId = null; // Track the last loaded message ID for fetching earlier messages
...
// // Function to display a single private message
// function displayPrivateMessage(messageData, isSender, prepend = false) {
//   const privateMessages = document.getElementById("privateMessages");
//   const messageElement = document.createElement("div");
//   messageElement.className = `message ${isSender ? "sent" : "received"}`;
//   const timestamp = new Date(messageData.timestamp).toLocaleTimeString();
...
//   // Parse page and pageSize to ensure they are integers
//   page = parseInt(page);
//   pageSize = parseInt(pageSize);

//   // Validate page and pageSize to prevent NaN errors
//   if (isNaN(page) || page < 1) {
//     page = 1; // Set default page number if invalid or not provided
//   }
//   if (isNaN(pageSize) || pageSize < 1) {
//     pageSize = 10; // Set default page size if invalid or not provided
//   }
...
//   fetch(
//     `/messages?sender=${encodeURIComponent(
//       username
//     )}&recipient=${encodeURIComponent(recipient)}&page=${encodeURIComponent(
//       page
...
// // Function to display messages in the chat interface from bottom to top
...
// //   if (isLoadingMessages || currentMessages.length === 0) return;
// //   isLoadingMessages = true;
// //   fetchPrivateMessages(currentRecipient, lastMessageId, pageSize);
// // }
